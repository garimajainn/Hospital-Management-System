...
<div id="header2">
<h2 align="center">Diagnostics Detail</h2>
<!--div class="center"-->


<form action="HospitalController" method="post" name="getDiagnosticsForm"
			autocomplete="off">
			<input type="hidden" name="source" value="getDiagnosticsDetail">

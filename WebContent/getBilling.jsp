...
<div id="header2">
<h2 align="center">Patient Billing Detail</h2>
<!--div class="center"-->


<form action="HospitalController" method="post" name="getBillingForm"
			autocomplete="off">
			<input type="hidden" name="source" value="getBillingDetail">

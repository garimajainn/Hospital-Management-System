...
<div id="header2">
<h2 align="center">Delete Patient</h2>
<!--div class="center"-->

<% Hospital obj = (Hospital)request.getAttribute("hospital"); %>

		<form action="HospitalController" method="post" name="patientDeleteForm"
			autocomplete="off">
			<input type="hidden" name="source" value="deletePatient">
			<table cellpadding=2 align="center">
			<tr>
			<th>Patient ID*</th>
			 <td><input type="text" name="patientId" placeholder="Id" value="<%=obj.getPatientId()%>" required></td>
			 </tr>
			 <tr>
			 <th>Patient Name</th>
			 <td><input type="text" name="name" placeholder="Name" value="<%=obj.getPatientName()%>" required></td>
			 </tr>
			 <tr>
			 <th>Patient Age</th>
			 <td><input type="text" name="age" placeholder="Age" value="<%=obj.getPatientAge()%>" required></td>
			 </tr>
			 <tr>
			 <th>Date of Admission</th>
			 <td><input type="text" name="date" placeholder="DD/MM/YYYY" value="<%=obj.getDateOfAdmission()%>" required></td>
			 </tr>
			 <tr>
			 <th>Type of Bed</th>
			 <td><input type="text" name="bed" placeholder="Single/Double" value="<%=obj.getBedtype()%>" required>	
			 </td>
			 </tr>
			 <tr>
			 <th>Address</th>
			 <td><input type="text" name="address" placeholder="Address" value="<%=obj.getAddress()%>" required>
			 </td>
			 </tr>
			 <tr>
			 <th>State</th>
			 <td><input type="text" name="state" placeholder="State" value="<%=obj.getState()%>" required>
			</td>
			 </tr>
			 <tr>
			 <th>City</th>
			 <td><input type="text" name="city" placeholder="City" value="<%=obj.getCity()%>" required>
			</td>
			 </tr>
			 </table>
			 <centre>

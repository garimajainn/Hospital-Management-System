...
<form action="HospitalController" method="post" name="SearchPatientGetForm"
			autocomplete="off">
			<input type="hidden" name="source" value="getSearchPatient">
		...
		<form action="HospitalController" method="post" name="patientsSearchForm"
			autocomplete="off">
			<input type="hidden" name="source" value="searchPatients">
			<table cellpadding=2 align="center">
			 <tr>
			 <th>Patient Name</th>

...
<form action="HospitalController" method="post" name="patientDeleteGetForm"
			autocomplete="off">
			<input type="hidden" name="source" value="getDeletePatient">
		...
		<form action="HospitalController" method="post" name="patientUpdatesForm"
			autocomplete="off">
			<input type="hidden" name="source" value="deletePatients">
			<table cellpadding=2 align="center">
			 <tr>
			 <th>Patient Name</th>

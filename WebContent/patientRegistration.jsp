...
<centre>
		<form action="HospitalController" method="post" name="patientRegistrationForm"
			autocomplete="off">
			<input type="hidden" name="source" value="patientRegistration">
			<table align="center">
			<tr>
			<th>Patient SSN ID*</th>
			 <td><input type="text" name="ssnId" placeholder="SSNID" required></td>
			 </tr>
			 <tr>
			 <th>Patient Name*</th>
		...
		<%
			...
			if(patientId != null)
			{
				out.println("<font color=red><h2> Patient added successfully .... </h2></font>");
				out.println("<font color=red><h2>Patient Id : <u>"+patientId+"</u></h2></font>");
			}	

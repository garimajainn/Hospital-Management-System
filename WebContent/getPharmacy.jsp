...
<div id="header2">
<h2 align="center">Pharmacy Detail</h2>
<!--div class="center"-->


<form action="HospitalController" method="post" name="getPharmacyForm"
			autocomplete="off">
			<input type="hidden" name="source" value="getPharmacyDetail">
